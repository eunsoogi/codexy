...
| Review gate contract                  | `plugins/codexy/skills/orchestration/references/review-profiles.md`                                                                      | Proportionate current-head reviewer selection; retired legacy paths are unsupported.                                                                       |
