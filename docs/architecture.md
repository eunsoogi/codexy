...
| `planning`                     | Keep     | Creating or updating actionable project plans with optional local persistence.                                                                                                     | Produces self-contained, source-backed plans and safe local storage without creating execution authority, issues, or new receipts.                                                                                                                |
