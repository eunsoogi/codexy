...
| `codexy-auditor`      | `gpt-6-sol`   | `medium`         | Turns acceptance criteria into observable QA across configuration, documentation, CLI, GitHub, app, and plugin surfaces.                            |
...
| `codexy-inspector`    | `gpt-6-sol`   | `medium`         | Performs the single bounded standard-profile review of current acceptance, changed files, and direct correctness, regression, and scope boundaries. |
...
| `codexy-shipwright`   | `gpt-6-sol`   | `high`           | Prepares version, manifest, marketplace, artifact, tag, release, and rollback readiness.                                                            |
