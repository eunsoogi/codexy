...
def validate_issue(
    ...
    CanonicalIssueIdentity.parse(url, number, f"governing issue #{number}")
...
{"Fixes" if issue_link_mode == "closing" else "Tracks"} #{number}
"""
    return title, body
