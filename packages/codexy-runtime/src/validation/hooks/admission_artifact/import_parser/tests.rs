...
fn imports_track_static_policy_forms_without_tracking_neutral_imports() {
    let imports = imports(
        ...
        "import codexy_policy.shell_destructive_policy\n\
         import codexy_policy.shell_opaque as opaque\n\
         from codexy_policy import shell_opaque\n\
         from codexy_policy.shell_destructive_policy import POLICY\n\
         from .shell_opaque import evaluate\n\
...
fn imports_ignore_policy_words_inside_triple_quoted_strings() {
    let imports = imports(
        "codexy_policy/shell_destructive.py",
        "\"\"\"\nfrom codexy_policy import shell_destructive_policy\n\"\"\"\nfrom dataclasses import dataclass\n",
    )
