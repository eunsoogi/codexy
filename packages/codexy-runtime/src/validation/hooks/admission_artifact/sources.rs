...
pub(super) const POLICY_SOURCES: &[Source] = &[
    ...
    source!("codexy_policy/title_api.py"),
    source!("codexy_policy/title_graphql.py"),
    source!("codexy_policy/title_merge.py"),
    source!("codexy_policy/title_nested.py"),
    source!("codexy_policy/title_nested_fields.py"),
    source!("codexy_policy/title_nested_parser.py"),
    source!("codexy_policy/title_nested_shell.py"),
