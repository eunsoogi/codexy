...
pub(super) const LAUNCHERS: &[Source] = &[
    ...
    source!("codexy-repository-github-exec.sh"),
    source!("codexy-repository-github-exec.cmd"),
...
pub(super) const POLICY_SOURCES: &[Source] = &[
    ...
    source!("codexy_repository_github_exec.py"),
    ...
    source!("codexy_policy/repository_github_exec.py"),
    source!("codexy_policy/repository_github_exec_literals.py"),
    source!("codexy_policy/repository_github_exec_parser.py"),
    source!("codexy_policy/repository_github_exec_structure.py"),
