...
/// Default wait duration for callers that omit `timeoutMs`.
pub(crate) const DEFAULT_WAIT_MS: u64 = 60_000;
/// Maximum bounded wait duration accepted by the Watcher MCP.
