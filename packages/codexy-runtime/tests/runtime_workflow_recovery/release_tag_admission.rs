#[path = "release_tag_admission/fixture_runtime.rs"]
mod fixture_runtime;
#[path = "release_tag_admission/fixture_scripts.rs"]
mod fixture_scripts;
#[path = "release_tag_admission/fixture_state.rs"]
mod fixture_state;
#[path = "release_tag_admission/fixture_support.rs"]
mod fixture_support;

use std::fs;

use fixture_runtime::{Fixture, assert_fixture_error_context};
use fixture_state::RemoteTag;
...
fn fixture_error_context_names_missing_fixture() -> Result<(), Box<dyn std::error::Error>> {
    ...
    assert_fixture_error_context(&path, temp.path(), false)
}
