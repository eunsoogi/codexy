...
fn cargo_declares_the_exact_seven_integration_shards() {
    ...
    assert_eq!(
        names,
        ["suite_support", "suite_agent", "suite_child", "suite_orchestration", "suite_governance", "suite_governance_workflows", "suite_system", "suite_runtime", "suite_runtime_activation", "suite_sync_version", "suite_archive"],
