...
expected_integrated_counts = {"posix": 2163, "windows": 2042}
...
check_cardinality_delta("posix one canonical identity extra", "posix", 1)
check_cardinality_delta("windows one canonical identity missing", "windows", -1)
