...
impl GateFixture {
    ...
    fn run_from_root_with_required_windows_job(
        ...
        command
            .arg(codexy_runtime::paths::repository_root().join("scripts/profile-rust-tests.py"))
