...
fn validate_open_pr_handoff(handoff: &str) -> OutputResult {
    ...
    std::fs::write(
        &pr_state_path,
        r#"{"number":128,"state":"OPEN","isDraft":false,"mergeStateStatus":"CLEAN","headRefOid":"head","reviewDecision":"NOT_REQUIRED","reviewProfile":"light","reviewThreads":{"pageInfo":{"hasNextPage":false},"nodes":[{"id":"PRRT_kwDOWaiting","isResolved":false,"isOutdated":false,"path":"src/validation/review_thread_resolution.rs","comments":{"nodes":[{"url":"https://github.com/eunsoogi/codexy/pull/174#discussion_r2"}]}}]}}"#,
    )?;
