...
const TERMINAL: &str = concat!(
    ...
    r#"{"id":"e-full","predecessor_event_id":null,"profile":"strict","base_oid":"base","head_oid":"abc","state":"full","full_used":1,"delta_used":0,"blockers":[],"boundaries":["validator"],"issue_contract":{"problem":"owned problem","scope":"owned scope","acceptance_criteria":[{"id":"ac-1"}],"owned_invariant_ids":[],"exclusions":[],"adjacent_dependencies":[]},"issue_contract_sha256":"30e2a0c55aa2db0a84e6924f5a4731f335ea652f79123af992903d8ec1c617e2","escalation":null},"#,
    r#"{"id":"e-passed","predecessor_event_id":"e-full","profile":"strict","base_oid":"base","head_oid":"abc","state":"passed","full_used":1,"delta_used":0,"blockers":[],"boundaries":["validator"],"issue_contract":{"problem":"owned problem","scope":"owned scope","acceptance_criteria":[{"id":"ac-1"}],"owned_invariant_ids":[],"exclusions":[],"adjacent_dependencies":[]},"issue_contract_sha256":"30e2a0c55aa2db0a84e6924f5a4731f335ea652f79123af992903d8ec1c617e2","escalation":null}]}}"#,
    "\\n"
);

const VALID_TERMINAL_LINE: &str = concat!(
    r#"{"schema":"codexy.review-terminal-record.v1","head_oid":"abc","profile":"strict","reviewer":{"name":"codexy-sentinel","model":"gpt-5.6-sol","reasoning_effort":"xhigh"},"state":"passed","event_id":"e-passed","blockers":[],"ledger":{"schema":"codexy.review-ledger.v1","events":[{"id":"e-full","predecessor_event_id":null,"profile":"strict","base_oid":"base","head_oid":"abc","state":"full","full_used":1,"delta_used":0,"blockers":[],"boundaries":["validator"],"issue_contract":{"problem":"owned problem","scope":"owned scope","acceptance_criteria":[{"id":"ac-1"}],"owned_invariant_ids":[],"exclusions":[],"adjacent_dependencies":[]},"issue_contract_sha256":"30e2a0c55aa2db0a84e6924f5a4731f335ea652f79123af992903d8ec1c617e2","escalation":null},{"id":"e-passed","predecessor_event_id":"e-full","profile":"strict","base_oid":"base","head_oid":"abc","state":"passed","full_used":1,"delta_used":0,"blockers":[],"boundaries":["validator"],"issue_contract":{"problem":"owned problem","scope":"owned scope","acceptance_criteria":[{"id":"ac-1"}],"owned_invariant_ids":[],"exclusions":[],"adjacent_dependencies":[]},"issue_contract_sha256":"30e2a0c55aa2db0a84e6924f5a4731f335ea652f79123af992903d8ec1c617e2","escalation":null}]}}"#,
    "\n"
);
