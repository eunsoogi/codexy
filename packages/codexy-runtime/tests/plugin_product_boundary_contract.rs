...
fn governed_universe(root: &Path) -> Result<BTreeSet<String>, Box<dyn std::error::Error>> { let mut governed = BTreeSet::new(); for path in [".agents/skills","plugins/codexy/hooks","plugins/codexy/skills","plugins/codexy/agents","plugins/codexy/mcp","plugins/codexy/lsp","assets","plugins/codexy/assets","scripts","packages/codexy-runtime/src/validation","packages/codexy-runtime/tests",".github/workflows","packages/codexy-runtime/src/codegraph","packages/codexy-runtime/src/lsp","packages/codexy-runtime/src/version","packages/codexy-runtime/src/bin","packages/getcodexy"] { governed.extend(files(root.join(path))?); } for path in ["packages/codexy-runtime/src/mcp.rs","packages/codexy-runtime/Cargo.toml","packages/codexy-runtime/Cargo.lock","packages/codexy-runtime/rust-toolchain.toml","packages/codexy-runtime/rustfmt.toml","packages/codexy-runtime/clippy.toml","plugins/codexy/bootstrap-codexy-agents","plugins/codexy/check-codexy-agents","plugins/codexy/runtime-release.json",".agents/plugins/marketplace.json",".agents/plugins/release-publish-contract.json",".agents/plugins/runtime-activation.json","plugins/codexy/.codex/lsp-client.json","plugins/codexy/.codex-plugin/plugin.json","plugins/codexy/agents/openai.yaml","README.md","README.ko.md"] { governed.extend(files(root.join(path))?); } Ok(governed) }
