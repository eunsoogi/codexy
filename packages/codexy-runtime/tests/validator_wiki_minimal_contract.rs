...
fn contract_parser_rejects_each_structural_contract_violation() -> TestResult {
    ...
    let mutations = vec![
        ...
        ("backtick NBSP closing suffix", original.replacen("| Current workflow |", "````text\n````\u{00a0}\n| Current workflow |", 1).replacen("\n\nCross-cutting", "\n````\u{00a0}\n````\n\nCross-cutting", 1)),
        ("backtick vertical-tab closing suffix", original.replacen("| Current workflow |", "````text\n````\u{000b}\n| Current workflow |", 1).replacen("\n\nCross-cutting", "\n````\u{000b}\n````\n\nCross-cutting", 1)),
        ("backtick form-feed closing suffix", original.replacen("| Current workflow |", "````text\n````\u{000c}\n| Current workflow |", 1).replacen("\n\nCross-cutting", "\n````\u{000c}\n````\n\nCross-cutting", 1)),
        ("tilde NBSP closing suffix", original.replacen("| Current workflow |", "~~~~text\n~~~~\u{00a0}\n| Current workflow |", 1).replacen("\n\nCross-cutting", "\n~~~~\u{00a0}\n~~~~\n\nCross-cutting", 1)),
        ("tilde vertical-tab closing suffix", original.replacen("| Current workflow |", "~~~~text\n~~~~\u{000b}\n| Current workflow |", 1).replacen("\n\nCross-cutting", "\n~~~~\u{000b}\n~~~~\n\nCross-cutting", 1)),
        ("tilde form-feed closing suffix", original.replacen("| Current workflow |", "~~~~text\n~~~~\u{000c}\n| Current workflow |", 1).replacen("\n\nCross-cutting", "\n~~~~\u{000c}\n~~~~\n\nCross-cutting", 1)),
