...
HOOKS = {
    ...
    "github": {
        "hooks": {
            ...
            "PermissionRequest": [
                _command_hook(
                    CONNECTOR_MATCHER, "codexy-repository-issue", "PermissionRequest"
                ),
            ...
            "PreToolUse": [
                ...
                _command_hook(
                    CONNECTOR_MATCHER, "codexy-repository-issue", "PreToolUse"
                ),
