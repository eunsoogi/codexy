...
def _connector(
    ...
    *,
    ...
    return Mutation(
        kind,
        True,
        int(value) if positive_int(value) else None,
        title,
        BodyEvidence(body, BodySource.INLINE) if isinstance(body, str) else None,
        int(linked) if positive_int(linked) else None,
    )
