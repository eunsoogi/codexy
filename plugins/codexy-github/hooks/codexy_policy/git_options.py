...
SCHEMAS: dict[str, dict[str, ValueMode]] = {
    "reset": {
        ...
        "no-refresh": "none",
        "intent-to-add": "none",
        "no-intent-to-add": "none",
        "recurse-submodules": "optional-equals",
        "no-recurse-submodules": "none",
        "pathspec-from-file": "required",
        "pathspec-file-nul": "none",
    },
    "clean": {
        "force": "none",
        "interactive": "none",
    ...
    "push": {
        "force": "none",
        "force-with-lease": "optional-equals",
        ...
        "atomic": "none",
        "follow-tags": "none",
        "signed": "optional-equals",
        "no-signed": "none",
        "push-option": "required",
        "receive-pack": "required",
        "repo": "required",
        "thin": "none",
        "no-thin": "none",
        "ipv4": "none",
...
def normalize(operation: str, arguments: list[str]) -> list[str] | None:
    ...
    while index < len(arguments):
        ...
        if provided in schema:
            ...
            matches = [
                candidate for candidate in schema if candidate.startswith(provided)
            ]
            if len(matches) != 1:
                return None
            name = matches[0]
