...
*[Gg][Ii][Tt][Hh][Uu][Bb]* | *[Ii][Ss][Ss][Uu][Ee]* | *[Pp][Uu][Ll][Ll]\ [Rr][Ee][Qq][Uu][Ee][Ss][Tt]* | *[Pp][Uu][Ll][Ll][Rr][Ee][Qq][Uu][Ee][Ss][Tt]* | *[Rr][Ee][Vv][Ii][Ee][Ww]* | *[Mm][Ee][Rr][Gg][Ee]*)
	# shellcheck disable=SC2016 # $git-workflow is literal prompt text.
		printf '%s\n' '{"hookSpecificOutput":{"hookEventName":"UserPromptSubmit","additionalContext":"Codexy GitHub workflow is installed. Use $git-workflow; GitHub authorization remains with the host, connector, and GitHub."}}'
	;;
esac
