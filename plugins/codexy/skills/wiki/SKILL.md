...
Use this skill as Codexy's packaged LLM Wiki methodology. Keep the upstream
wiki workflow intact: do not replace it with a short summary when creating or
...
capture, rehydration, inventory, compilation, audit, or query workflows, route
...
- Do not store secrets, private logs, local credentials, or machine-specific
  paths in wiki artifacts.
- Use the packaged Codexy reviewer agent at the end of non-trivial wiki work
