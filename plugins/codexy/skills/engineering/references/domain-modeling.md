...
Model domain meaning before code shape. MUST keep names, invariants, and ownership boundaries aligned with the actual workflow so transport, storage, UI, or framework details MUST NOT leak into core decisions.
