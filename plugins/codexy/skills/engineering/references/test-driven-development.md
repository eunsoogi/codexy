...
Make the desired engineering behavior fail for the right reason before changing production code. Then make the smallest change that turns the proof green and MUST keep broader verification
proportional to risk.

Documentation, README, instruction-only skill prose, and reference Markdown MUST NOT use manufactured RED tests, phrase mutations, or prose TDD. MUST verify those edits by direct diff and readback
plus applicable existence, link, render, frontmatter, or package-structure checks.
