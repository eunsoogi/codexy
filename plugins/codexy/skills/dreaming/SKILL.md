...
only that plan as recovery context after refreshing live state. MUST NOT
discover or select another plan.

- MUST treat the plan as an auxiliary record, not authority over the native
