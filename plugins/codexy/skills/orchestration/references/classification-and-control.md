...
The supported connector capture MUST follow [authenticated GitHub connector](connector-capture.md)
for its source, derivation, contradiction, and live-proof boundaries.
