...
| Reversibility | Easy / costly / irreversible            | Easy permits authorized reversible experiments. Before costly or irreversible commitment, MUST use authorized read-only observation, validation, or a reversible probe, retaining existing permission requirements.   |
