...
MUST use this contract for Codexy user-facing progress updates, blockers, completion summaries, and next actions in English or Korean. MUST keep exact workflow control and proof in their separate evidence surfaces.
