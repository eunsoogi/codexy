...
- MUST read [parent supervision](references/parent-supervision.md) when an
  issue uses app-thread workers, a watcher, worker callbacks, drift correction,
  or delegated goal ownership.
