...
fn validator_rejects_generic_reviewer_gate_pass_as_sentinel_readiness() -> TestResult {
    for handoff in [
        ...
        "PR ready for parent handoff. Reviewer gate: PASS. Pushed: yes.\n",
        "PR ready for parent handoff. Packaged Codexy reviewer gate result: PASS. Pushed: yes.\n",
        "PR ready for parent handoff. Packaged reviewer gate verdict: PASS. Pushed: yes.\n",
        "PR ready for parent handoff. Reviewer gate approved. Pushed: yes.\n",
