...
fn validator_distinguishes_governing_progressive_setup_predicates() -> TestResult {
    ...
    for (setup, expected) in [
        ...
        ("The child cannot have been actively setting up worktree codexy/463 before classification.", true),
        ...
        ("The child was under no supervision actively setting up worktree codexy/463 before classification.", false),
        ("The child was under no pressure actively setting up worktree codexy/463 before classification.", false),
        ("Under no circumstances was the child actively setting up worktree codexy/463 before classification.", true),
        ...
        ("Under no ordinary circumstances was the child actively setting up worktree codexy/463 before classification.", true),
        ("Under no normal circumstances was the child actively setting up worktree codexy/463 before classification.", true),
        ("Under no exceptional circumstances was the child actively setting up worktree codexy/463 before classification.", true),
