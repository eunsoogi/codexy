...
fn validator_requires_an_affirmative_current_thread_owner_assertion() -> TestResult {
    ...
    let cases = [
        (
            "explicit affirmative because rationale",
        ...
        (
            ...
            "affirmative current-thread-owned because ambiguous ownership is recorded for another lane",
            true,
        ),
        (
            "optional rationale is valid after explicit affirmation",
            "affirmative current-thread-owned",
            true,
        ),
        (
            "leading owner negation",
            "affirmative not current-thread-owned because the active thread owns issue-sized work",
            false,
        ),
        (
        ...
        (
            "missing affirmation marker",
            "current-thread-owned because not allowed to act",
            false,
        ),
        (
            "empty because rationale",
            "affirmative current-thread-owned because",
            false,
        ),
        (
