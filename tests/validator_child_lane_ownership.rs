...
fn validator_rejects_negative_reassignment_phrasing() -> Result<(), Box<dyn std::error::Error>> {
    for phrase in [
        ...
        "Maintainer reassignment: maintainer has not explicitly reassigned to parent",
        "Maintainer reassignment: maintainer has not reassigned implementation ownership to parent",
        "Maintainer reassignment: implementation ownership was not reassigned to parent",
        ...
        "Maintainer reassignment: explicit maintainer reassignment to parent not provided by @maintainer",
        "Maintainer reassignment: explicit maintainer reassignment to parent not provided.",
        ...
        "Maintainer reassignment: explicit maintainer reassignment to parent was not granted by @maintainer",
        ...
        "Maintainer reassignment: explicit maintainer reassignment to parent denied by @maintainer",
        "Maintainer reassignment: explicit maintainer reassignment to parent was rejected",
        "Maintainer reassignment: explicit maintainer reassignment to parent rejected by @maintainer",
