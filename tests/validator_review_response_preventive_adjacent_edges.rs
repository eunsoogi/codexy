...
fn validator_rejects_colon_labeled_post_negated_preventive_coverage() -> TestResult {
    for handoff in [
        ...
        "Review response: fixed the Codex review comment and verified current head. Preventive adjacent review: regression tests did not run; adjacent parser variants in the helper family were inspected manually.\n",
        "Review response: fixed the Codex review comment and verified current head. Preventive adjacent review: focused tests didn't execute; adjacent parser variants in the helper family were inspected manually.\n",
        ...
        "Review response: fixed the Codex review comment and verified current head. Preventive adjacent review: regression tests cover the exact review comment only; adjacent workflow variants in the helper family were inspected manually.\n",
    ] {
        let output = validate_handoff_with_pr_state(handoff, resolved_review_thread_pr_state())?;
        assert!(
            !output.status.success(),
