...
#[path = "validator_completion_handoff/support.rs"]
mod completion_handoff_support;
use completion_handoff_support::{
    accept_open_pr_handoff, reject_open_pr_completion_handoff, validate_handoff_with_pr_state,
};
...
fn validator_cli_rejects_empty_no_merge_instruction_labels() -> TestResult {
    for handoff in [
        ...
        "No-merge instruction: maintainer requested a automated review only. Work is complete after PR #128.\n",
        ...
        "Draft-only instruction: maintainer requested a automated review only. Work is complete after PR #128.\n",
...
fn validator_cli_rejects_false_or_unrelated_deferrals() -> TestResult {
    for handoff in [
        ...
        "Maintainer explicitly requested a automated review. Work is complete after PR #128.\n",
        "Maintainer requested no merge = false. Work is complete after PR #128.\n",
...
#[test]
fn validator_completion_handoff_matrix() -> TestResult {
    validator_cli_rejects_completion_claim_with_clean_open_pr()?;
    validator_cli_rejects_completion_claim_with_open_pr()?;
    validator_cli_allows_explicit_stop_condition_with_clean_open_pr()?;
    validator_cli_rejects_completion_claim_that_only_says_waiting_for_merge()?;
    validator_cli_rejects_completion_claim_that_negates_explicit_stop()?;
    validator_cli_rejects_empty_stop_condition_label()?;
    validator_cli_rejects_missing_pr_state_fields()?;
    validator_cli_rejects_empty_no_merge_instruction_labels()?;
    validator_cli_rejects_false_or_unrelated_deferrals()?;
    validator_cli_rejects_natural_completion_claims_after_pr()?;
    validator_cli_accepts_negated_completion_claim_after_pr()?;
    Ok(())
}
