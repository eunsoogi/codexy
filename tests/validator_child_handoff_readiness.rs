...
fn validator_allows_child_handoff_with_matching_clean_evidence() -> TestResult {
    let output = validate_handoff_with_pr_state(
        "Child handoff: branch clean, synced, and pushed at 068dbb247b7755035223c91ee39f26830f3c1609. Sentinel: PASS on current head 068dbb247b7755035223c91ee39f26830f3c1609. PR ready for parent handoff; parent will handle merge gates.\n",
        &pr_state_with(
