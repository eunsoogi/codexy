...
-> Result<(), Box<dyn std::error::Error>> {
    ...
    for required in [
        ...
        "one complete runtime-issued monitor identity",
        "heartbeat route MUST bind the observation to its heartbeat automation id",
        "heartbeat route MUST NOT require a persistent exec/session identifier",
        "separate process-backed monitor MUST bind the observation",
        ...
        "without either complete runtime-issued identity",
