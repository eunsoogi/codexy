...
fn validator_allows_orchestrator_authored_fallback_route() -> Result<(), Box<dyn std::error::Error>>
{
    for route in [
        ...
        "Fallback route: handler did not verify; parent posted the handoff in the child thread",
        "Fallback route: handler actually did not verify: parent posted the handoff in the child thread",
        "Fallback route: handler could not verify: parent posted the handoff in the child thread",
        "Fallback route: tool could not verify: parent posted the handoff in the child thread",
        "Fallback route: Codex app child thread request failed; handler could not verify: parent posted the handoff in the child thread",
        "Fallback route: handler could not verify; Codex app child thread request failed; parent posted the handoff in the child thread",
        "Fallback route: no child thread tool handler was available; parent posted the handoff in the child thread",
        "Fallback route: no child thread tool handler is registered; parent posted the handoff in the child thread",
        "Fallback route: no child thread tool handlers were available; parent posted the handoff in the child thread",
        "Fallback route: no child thread tool handlers are provided; parent posted the handoff in the child thread",
...
fn validator_rejects_non_orchestrator_fallback_route() -> Result<(), Box<dyn std::error::Error>> {
    for route in [
        ...
        "Fallback route: handler context noted, we could not verify: parent posted the handoff in the child thread",
        ...
        "Fallback route: no child; parent posted the handoff in the child thread",
        "Fallback route: no child was available; parent posted the handoff in the child thread",
        "Fallback route: no assigned child; parent posted the handoff in the child thread",
        "Fallback route: no valid child; parent posted the handoff in the child thread",
        "Fallback route: no child thread tool; parent posted the handoff in the child thread",
        "Fallback route: no child thread tool was used; parent posted the handoff in the child thread",
        "Fallback route: no child thread tool owner; parent posted the handoff in the child thread",
        "Fallback route: no child thread tool handlers; parent posted the handoff in the child thread",
        "Fallback route: no child thread tool handlers were used; parent posted the handoff in the child thread",
