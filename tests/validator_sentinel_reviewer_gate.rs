...
fn validator_cli_rejects_negated_reasoning_control_evidence() -> TestResult {
    for replacement in [
        ...
        "Every approval MUST reference reasoning control used or unavailable evidence if feasible",
        ...
        "Every approval MUST reference reasoning control used or unavailable evidence where needed",
        "Every approval MUST reference reasoning control used or unavailable evidence as applicable",
        "Every approval MUST reference reasoning control used or unavailable evidence as appropriate",
        ...
        "reasoning control used or unavailable evidence ought to be recorded",
        "reasoning control used or unavailable evidence is advisable",
        ...
        "reasoning control used or unavailable evidence. The reviewer may skip it",
        "reasoning control used or unavailable evidence. The reviewer can skip it",
