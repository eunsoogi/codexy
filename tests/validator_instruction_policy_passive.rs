...
fn validator_cli_rejects_markdown_workflow_bare_imperatives() -> TestResult {
    ...
    for addition in [
        ...
        "- Add/update index rows.",
        "- Append evidence to the handoff.",
        "- If tags introduce a category, add it to the Categories section.",
        "- **Renamed a field?** Append an alias entry.",
        "- **Changed an enum value?** Add a value alias.",
        "- **New manifest rule?** Update C8.",
        "1. Each category `_index.md` — add/update rows.",
