...
const POLICY_SOURCES: &[Source] = &[
    ...
    Source {
        path: "codexy_policy/git_options.py",
        contents: include_str!("../../../plugins/codexy/hooks/codexy_policy/git_options.py"),
    },
    Source {
    ...
    Source {
        path: "codexy_policy/github_api.py",
        contents: include_str!("../../../plugins/codexy/hooks/codexy_policy/github_api.py"),
    },
    Source {
