...
const PENDING_REVIEW_FEEDBACK: &str = "pending codex review feedback|pending @codex review feedback|pending review feedback|codex review feedback is pending|@codex review feedback is pending|review feedback is pending|codex review feedback pending|@codex review feedback pending|review feedback pending|codex review feedback has not returned|@codex review feedback has not returned|review feedback has not returned|codex review feedback has not yet returned|@codex review feedback has not yet returned|review feedback has not yet returned|codex review is pending feedback from the connector|@codex review is pending feedback from the connector|waiting on codex review feedback|waiting on @codex review feedback|waiting on review feedback|waiting on feedback|waiting for codex review feedback|waiting for @codex review feedback|waiting for review feedback|waiting for feedback|awaiting codex review feedback|awaiting @codex review feedback|awaiting review feedback|awaiting feedback|codex review feedback from the connector|review feedback from the connector|feedback to arrive";
