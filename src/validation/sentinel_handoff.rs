...
const READINESS_MARKERS: &str = "merge-ready|merge ready|ready to merge|ready for merge|ready for merge gates|ready for parent handoff|pr-ready|pr ready|pull-request-ready|pull request ready|parent can open pr next|parent can create pr next|parent can open the pr next|push-ready|push ready|ready to push|ready for push|push readiness: yes|push readiness yes|push readiness: true|push readiness true|pushed: yes|pushed yes|pushed: true|pushed true|remote/pr head match: yes|remote/pr head match yes|remote and pr head match";
