pub(super) const SENTINEL_MARKERS: &str =
    "sentinel|codexy-sentinel|packaged reviewer gate|reviewer gate|reviewer-gate";
...
const BLOCK_MARKERS: &str = "sentinel: block|sentinel block|sentinel returned block|sentinel status: block|sentinel verdict: block|sentinel result: block|sentinel gate returned block|reviewer gate returned block|reviewer gate result: block|reviewer-gate result: block";
