...
fn has_negative_label_value(suffix: &str) -> bool {
    ...
    "not ready|not yet ready|not currently ready|isn't ready|isn't yet ready|aren't ready|aren't yet ready|false|not requested|not applicable|isn't applicable|aren't applicable"
        .split('|')
